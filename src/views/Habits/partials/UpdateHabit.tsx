...
const UpdateHabit: FC<Props> = ({ title, onTouchOutside, show, userHabit }) => {
    ...
    return (
      <Formik
        ...
        onSubmit={async (values) => {
          ...
          try {
            const response = await patientService.updateHabit({
              patientHabitId: userHabit.id,
              userId: userHabit.patientId,
